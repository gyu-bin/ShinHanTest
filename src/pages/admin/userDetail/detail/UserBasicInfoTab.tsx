...
const UserBasicInfoTab: React.FC<Props> = ({ user, randomLoginDate }) => {
    return (
        <Box>
            <Box px={2} py={2}>
                <Typography fontWeight={600} mb={2}>사용자 정보</Typography>
                <Table size="small">
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell>
                                <Button variant="outlined" size="small" startIcon={<CheckCircleIcon color="primary" />} disabled>
                                    재직
                                </Button>
                            </TableCell>
                        </TableRow>
            ...
            <Box px={2} py={2}>
                <Typography fontWeight={600} mb={2}>접속 정보</Typography>
                <Table size="small">
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell align="right">
                                <Button variant="outlined" size="small">사용 이력 모니터링</Button>
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
